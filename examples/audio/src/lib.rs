...
pub struct FMOscillator {
    ...
    // Ammount of frequency modulation
...
impl FMOscillator {
    ...
    pub fn new() -> Result<FMOscillator, JsValue> {
        ...
        osc.frequency().set_value(440.0); // A4 note
    ...
    pub fn set_fm_amount(&mut self, amt: f32) {
        ...
        self.fm_gain
            .gain()
            .set_value(self.fm_gain_ratio * self.osc.frequency().value());
    }
    ...
    pub fn set_fm_frequency(&mut self, amt: f32) {
        ...
        self.fm_osc
            .frequency()
            .set_value(self.fm_freq_ratio * self.osc.frequency().value());
    }
}